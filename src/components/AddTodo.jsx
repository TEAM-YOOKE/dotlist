...
function AddTodo({ addTodo, loading }) {
  ...
  return (
    <form
      ...
      className="flex flex-col md:flex-row items-center rounded-lg w-full -mt-6 mb-10 gap-2 md:gap-4 justify-start"
    >
      <input
        type="text"
        name="title"
        ...
        className="w-full md:flex-1 p-2 text-white bg-[#262626] placeholder-[#808080] rounded-md outline-none focus:ring-2 focus:ring-blue-500 h-[54px]"
      />
      <input
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full md:w-auto flex bg-[#1e6f9f] text-white p-4 rounded-md transition duration-300 gap-x-2 text-sm font-bold items-center justify-center"
      >
